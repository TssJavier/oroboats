...
interface PricingOption {
  ...
  price: number
  label: string
  // ✅ NUEVO: Añadir startTime y endTime para franjas específicas
  startTime?: string
  endTime?: string
}
...
// ✅ ACTUALIZADO: NUEVAS FRANJAS HORARIAS - AÑADIR startTime y endTime
const TIME_SLOTS = {
  boat_no_license: [
    {
      duration: "2hour",
      label: "2 horas (10:00 - 12:00)",
      hours: 2,
      defaultPrice: 199,
      startTime: "10:00",
      endTime: "12:00",
...
export function VehicleForm({ vehicle, onSuccess, onCancel }: VehicleFormProps) {
  ...
  const generateTimeSlots = () => {
    ...
    const newPricing = slots.map((slot) => ({
      ...
      label: slot.label,
      startTime: slot.startTime, // ✅ Incluir startTime
      endTime: slot.endTime, // ✅ Incluir endTime
    }))
